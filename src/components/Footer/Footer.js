...
const Footer = () => {
    ...
    return (
        <footer>
            <div className='ph3 ph5-ns tc'>
                <a className="link near-black hover-silver dib h2 w2 mr3" href="#" title="Instagram">   
            ...
            <div className="db">
                <p className="f7 black-70 mt4 tc fixed right-1 bottom-0">
